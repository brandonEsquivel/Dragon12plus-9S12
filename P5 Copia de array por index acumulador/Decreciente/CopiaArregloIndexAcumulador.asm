...
;;==============================================================================
                ...
                ldab #N                  ;se inicializa el contador CON EL ACUMULADOR B = N (10 en este caso)
                decb                     ;se carga N-1 en B
		ldy  #MAYORES            ;cargar en Y direcicon de arreglo destino para los datos que cumplen las condiciones
                aby                      ;se inicia en ADRS+N-1, es el ultimo elemento del array. Barrido decreciente
Lazo:
                ...
                movb b,X,1,Y-          ;se aplica la copia/el traslado de los datos a la posicion destino
